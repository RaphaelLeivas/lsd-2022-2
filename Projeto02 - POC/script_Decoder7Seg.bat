...
ghdl -r tb_Decoder7Seg --vcd=tb_Decoder7Seg.vcd
pause

:: Modifique a linha a seguir com o nome do arquivo .vcd que deseja visualizar com o GTKWAVE.
gtkwave -f tb_Decoder7Seg.vcd  --script=gtkwave_print.tcl
