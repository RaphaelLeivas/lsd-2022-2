...
ghdl -r tb_aula4_comp_ex1_b --vcd=tb_aula4_comp_ex1_b.vcd
:: Modifique a linha a seguir com o nome do arquivo .vcd que deseja visualizar com o GTKWAVE.
gtkwave -f tb_aula4_comp_ex1_b.vcd  --script=gtkwave_print.tcl
:Done
