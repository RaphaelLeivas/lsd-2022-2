...
ghdl -r tb_ComponentEx8 --vcd=tb_ComponentEx8.vcd
pause

:: Modifique a linha a seguir com o nome do arquivo .vcd que deseja visualizar com o GTKWAVE.
gtkwave -f tb_ComponentEx8.vcd  --script=gtkwave_print.tcl
